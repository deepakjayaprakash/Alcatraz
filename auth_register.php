  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        <li><a href="A-Auth.html">HOME</a></li>
...
<div class="jumbotron text-center">
  <h1>A-Auth: Register your application now! </h1> 
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
  ...
  $query = mysql_query("Select * from A_Auth"); //Query the users table
  while($row = mysql_fetch_array($query)) //display all rows from query
  {
    ...
    if($username == $table_users) // checks if there are any matching fields
    {
      ...
      Print '<script>window.location.assign("auth_register.php");</script>'; // redirects to register.php
    }
  }
  if($bool) // checks if bool is true
  {
      ...
      $client_secret_key=generateRandomString();
      
    mysql_query("INSERT INTO A_Auth (username, password,client_id,client_secret_key) VALUES ('$username','$password','$client_id','$client_secret_key')"); //Inserts the value to table users
