  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        ...
        <li><a href="auth_register.php">REGISTER</a></li>
...
<div class="jumbotron text-center">
  <h1>A-Auth:  A DEVELOPER FRIENDLY AUTHENTICATION PROTOCOL </h1> 
    ...
    <div class="col-sm-6 col-xs-12" >
      <div class="panel panel-default text-center">
        ...
        <div class="panel-body">
            <form action="auth_checklogin.php" method="POST">
          ...
          <h3>New user? <a href="auth_register.php">Register</a></h3>
      </div>      
    </div>     
